...
public class ConfigScreen extends Screen {
    ...
    public void onClose() {
        HudConfig.save();
        // MC 26.2 removed Minecraft.setScreen(Screen); setScreenAndShow(Screen) is the only
        // public entry point left (Minecraft.class bytecode confirmed setScreen's removal).
