...
public class CoordinatesHudRenderer {
    ...
    public static void render(PoseStack poseStack) {
        ...
        int bgX1 = position.resolveX(mc.getWindow().getGuiScaledWidth(), hudWidth, MARGIN);
        int bgY1 = position.resolveY(mc.getWindow().getGuiScaledHeight(), hudHeight, MARGIN);

        GuiComponent.fill(poseStack, bgX1, bgY1, bgX1 + hudWidth, bgY1 + hudHeight, BACKGROUND_COLOR);
