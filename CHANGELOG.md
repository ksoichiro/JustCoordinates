...
- Minecraft 26.3 support for Forge
...
- Minecraft 26.2 support for Fabric, NeoForge, and Forge

## [0.4.0] - 2026-04-11

### Added

- Minecraft 26.1.1 and 26.1.2 support for Fabric, NeoForge, and Forge
...
- XYZ coordinates HUD display in the top-left corner with gray background and white text (Bedrock Edition style)
- Format: `Position: X, Y, Z`
- Auto-hide when F3 debug screen is displayed
- Auto-hide when HUD is hidden (F1 key)
- Multi-loader support: Fabric, NeoForge, Forge
- Minecraft version support: 1.19.2, 1.20.1, 1.21.1, 1.21.3-1.21.11

[Unreleased]: https://github.com/ksoichiro/JustCoordinates/compare/v0.10.0...HEAD
[0.10.0]: https://github.com/ksoichiro/JustCoordinates/compare/v0.9.0...v0.10.0
